...
let main argv =
    ...
    // printfn "%A" (Solutions.problem42 (File.ReadAllLines @"data\42.txt"))
    // printfn "%A" (Solutions.problem43 ())
    // printfn "%A" (Solutions.problem44 ())
    // printfn "%A" (Solutions.problem45 143)
    // printfn "%A" (Solutions.problem46 ())
    // printfn "%A" (Solutions.problem47 4)
    // printfn "%A" (Solutions.problem48 1000I)
    // printfn "%A" (Solutions.problem49 ())
    // printfn "%A" (Solutions.problem50 1000000)
    // printfn "%A" (Solutions.problem51 ())
    // printfn "%A" (Solutions.problem52 6)
    // printfn "%A" (Solutions.problem53 100I 1000000I)
    printfn "%A" (Solutions.problem54 (File.ReadAllLines @"data\54.txt"))
